...
const News = () => {
	const { loading, error, data } = useFetch(
		'https://kashriff-admin.herokuapp.com/vlogs'
	);
			...
			<div className='row'>
				...
				>
					<div className='blog-grid' onClick={toggleModalOne}>
						<div className='blog-img'>
							<img src={data[0].image.url} alt='blog post'></img>
						</div>
				...
				>
					<div className='blog-grid' onClick={toggleModalTwo}>
						<div className='blog-img'>
							<img src={data[1].image.url} alt='blog post'></img>
						</div>
						<div className='blog-info'>
							{/* <div className='meta'>29/FEB/2020 - BY ALEX</div> */}
							<h6>
								<a href={data[1].url} target='_blank' rel='noreferrer'>
									{data[1].title}
								</a>
							</h6>
						</div>
				...
				>
					<div className='blog-grid' onClick={toggleModalThree}>
						<div className='blog-img'>
							<img src={data[2].image.url} alt='blog post'></img>
						</div>
						<div className='blog-info'>
							{/* <div className='meta'>29/FEB/2020 - BY ALEX</div> */}
							<h6>
								<a href={data[2].url} target='_blank' rel='noreferrer'>
									{data[2].title}
								</a>
							</h6>
						</div>
				...
				>
					<div className='blog-grid' onClick={toggleModalFour}>
						<div className='blog-img'>
							<img src={data[3].image.url} alt='blog post'></img>
						</div>
						<div className='blog-info'>
							{/* <div className='meta'>29/FEB/2020 - BY ALEX</div> */}
							<h6>
								<a href={data[3].url} target='_blank' rel='noreferrer'>
									{data[3].title}
								</a>
							</h6>
						</div>
